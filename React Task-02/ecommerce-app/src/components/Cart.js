      ...
      <form action="/Cart">
        <div className="row">
          <div className="col-50">
            ...
            <input type="text" id="fname" name="firstname" placeholder="Lokesh" />
            <label><i className="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="loki@example.com" />
            ...
            <div className="row">
              ...
              <div className="col-50">
                <label>Zip</label>
                <input type="text" id="zip" name="zip" placeholder="500043" />
              </div>
            </div>
